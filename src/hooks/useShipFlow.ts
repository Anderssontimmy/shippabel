  ...
  return [
    {
      id: "scan" as FlowStep,
      label: "Scan",
      description: "Check your app for store readiness",
      completed: scanned,
      available: true,
    },
    {
      id: "fix" as FlowStep,
      label: "Fix Issues",
      description: "Resolve critical issues blocking submission",
      completed: fixed,
      available: scanned,
    },
    {
      ...
      label: "Sign Up",
      description: "Create an account to save progress",
      completed: loggedIn,
      available: scanned,
    },
    {
      ...
      label: "Store Listing",
      description: "Generate store copy, keywords & privacy policy",
    ...
    },
    {
      ...
      label: "Screenshots",
      description: "Upload and frame screenshots for the store",
    ...
    },
    {
      ...
      description: "Link your Apple, Google & Expo accounts",
      completed: hasEas,
      available: loggedIn,
    },
    {
      ...
      label: "Build",
      description: "Create a production build via EAS",
      completed: hasBuild,
      available: hasEas,
    },
    {
      ...
      label: "Submit",
      description: "Submit to App Store & Google Play",
