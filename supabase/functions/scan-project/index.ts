...
const friendlyTitles: Record<string, string> = {
  "Cannot read app.json or app.config.js": "Your app needs mobile configuration",
  "Missing bundle identifier": "Your app needs a unique ID for the stores",
  "Default bundle identifier detected": "Your app's ID needs to be changed",
  "Missing app icon": "Your app needs an icon",
  "App icon file not found": "Your app icon file is missing",
  ...
  "No adaptive icon for Android": "Android needs a special icon format",
  "No app category set": "Pick a category for your app",
  "Environment file committed to repository": "Secret files are exposed in your code",
  "Environment files included in upload": "Secret files are in your upload",
  "No .gitignore file": "Some files need to be excluded",
  "No error boundary detected": "Your app could crash without a safety net",
};

const friendlyDescriptions: Record<string, string> = {
  "Cannot read app.json or app.config.js": "To publish on the App Store and Google Play, your app needs a configuration file. We can create this for you.",
  "Missing bundle identifier": "Every app on the App Store needs a unique identifier (like a license plate). We'll generate one for you.",
  "Default bundle identifier detected": "Your app is using a placeholder ID. We'll set a proper one for you.",
  "Missing app icon": "Both stores require an app icon (1024x1024 image). We can help you create one.",
  "No custom splash screen": "The loading screen is using a default. A custom one makes your app look more polished.",
  "Version not set": "The stores need a version number (like 1.0.0). We'll set it for you.",
  "Build number not set": "Each submission needs a build number. We'll set the first one for you.",
  "Missing privacy policy URL": "Apple and Google require a privacy policy. We can generate and host one for you.",
  "No adaptive icon for Android": "Android phones show icons in different shapes. We can fix this so your icon looks great everywhere.",
  "No app category set": "Choosing a category helps people find your app in the store.",
  "Environment file committed to repository": "Your project contains files with secret keys that could be stolen. We'll secure them.",
  "Environment files included in upload": "Your upload contains secret information. We'll make sure it's excluded.",
  "No .gitignore file": "Your project doesn't filter out temporary files and secrets. We'll add a filter.",
  "No error boundary detected": "If something goes wrong, your app could crash completely. A safety net keeps it running.",
};
